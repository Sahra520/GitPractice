...
public class day39_Class_Notes {
...
MUST happen in the child
class
return-type, method name,
parameter MUST be same
Access modifier need to be
same or more visible
public > protected > default
Method we can not override:
private, static, final
ONLY the instance methods
(not final & not private) can be overriden
@Overriden annotation must
be applicable
next Thursday:
